...
1. Primeiro você aprenderá sobre as propriedades **flex-direction**, **flex-wrap**, **flex-flow**, **reverse**, **justify-content**, **align-items** e **align-content**. Todas essas propriedades serão aplicadas em _containers_.

  * [_CSS Flexbox_ - parte I](/fundamentals/css-flexbox/css-flexbox-part-1)

2. Agora, aprenderá sobre as propriedades **align-self**, **order**, **flex-grow**, **flex-shrink** e **flex-basis**. Também veremos como podemos trabalhar com **margins** no **Flexbox**. Essas propriedades serão aplicadas em _items_.
