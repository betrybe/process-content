...
## Aula 26.5 - Praticando Express - Parte 2
<%= vimeo "481009113" %>
...
## Aula 22.2 - Normalização, Formas Normais e Dump 
<%= vimeo "466747890" %>
...
## Aula 16.4 - React com Redux - Parte 2 (2)
<%= vimeo "447193095" %>
...
## Aula 4.3 - Lógica de Programação e Algortimos - Resolução de Exercícios
<%= vimeo "418685909" %>
